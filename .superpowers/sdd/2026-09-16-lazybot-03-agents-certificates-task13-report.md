...
- Both package scripts also include `playwright-core`; launchers set `PLAYWRIGHT_BROWSERS_PATH` to the packaged browser directory before starting Node. The package smoke test verifies the core dependency and launcher still executes.
